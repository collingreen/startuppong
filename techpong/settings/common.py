...
SECRET_KEY = r"wfi8o$mr8h!beh@75jdiu2sh8v0lf1+((u3!zi5-lw#ac_y1z)"
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'apps.techpong.context_processors.google_analytics_key'
)
...
PIPELINE_JS = {
    'base': {
        'source_filenames': (
            ...
            'js/plugins/nivo-slider/jquery.nivo.slider.pack.js',
            ),
