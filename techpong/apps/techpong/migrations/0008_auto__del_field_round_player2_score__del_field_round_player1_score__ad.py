...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Round.player2_score'
        db.delete_column(u'techpong_round', 'player2_score')

        # Deleting field 'Round.player1_score'
        db.delete_column(u'techpong_round', 'player1_score')
    ...
    def backwards(self, orm):
        # Adding field 'Round.player2_score'
        db.add_column(u'techpong_round', 'player2_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Round.player1_score'
        db.add_column(u'techpong_round', 'player1_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    models = {
        ...
        u'techpong.round': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'loser_score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
