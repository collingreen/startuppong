...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.api_account_id'
        db.add_column(u'techpong_company', 'api_account_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Company.api_access_key'
        db.add_column(u'techpong_company', 'api_access_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.api_account_id'
        db.delete_column(u'techpong_company', 'api_account_id')

        # Deleting field 'Company.api_access_key'
        db.delete_column(u'techpong_company', 'api_access_key')
