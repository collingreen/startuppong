...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'techpong_notification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notification_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'techpong', ['Notification'])

        # Adding field 'UserProfile.last_viewed_notifications'
        db.add_column(u'techpong_userprofile', 'last_viewed_notifications',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'techpong_notification')

        # Deleting field 'UserProfile.last_viewed_notifications'
        db.delete_column(u'techpong_userprofile', 'last_viewed_notifications')
    ...
    models = {
        ...
        u'techpong.company': {
            ...
            'api_access_key': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            'api_account_id': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            ...
            'latest_change': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        u'techpong.notification': {
            'Meta': {'ordering': "['-notification_time']", 'object_name': 'Notification'},
        ...
        u'techpong.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_viewed_notifications': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
