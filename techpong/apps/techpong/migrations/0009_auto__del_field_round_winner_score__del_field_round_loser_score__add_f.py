...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Round.winner_score'
        db.delete_column(u'techpong_round', 'winner_score')

        # Deleting field 'Round.loser_score'
        db.delete_column(u'techpong_round', 'loser_score')

        # Adding field 'Round.winner'
        db.add_column(u'techpong_round', 'winner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='round_winner', null=True, to=orm['techpong.Player']),
                      keep_default=False)

        # Adding field 'Round.loser'
        db.add_column(u'techpong_round', 'loser',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='round_loser', null=True, to=orm['techpong.Player']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Round.winner_score'
        db.add_column(u'techpong_round', 'winner_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Round.loser_score'
        db.add_column(u'techpong_round', 'loser_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Round.winner'
        db.delete_column(u'techpong_round', 'winner_id')

        # Deleting field 'Round.loser'
        db.delete_column(u'techpong_round', 'loser_id')
