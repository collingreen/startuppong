...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.latest_change'
        db.add_column(u'techpong_company', 'latest_change',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 17, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.latest_change'
        db.delete_column(u'techpong_company', 'latest_change')
