...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.cached_results'
        db.add_column(u'techpong_player', 'cached_results',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.cached_results'
        db.delete_column(u'techpong_player', 'cached_results')
