...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.match_quality'
        db.add_column(u'techpong_match', 'match_quality',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Match.winner_rating_after'
        db.alter_column(u'techpong_match', 'winner_rating_after', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Match.loser_rating_before'
        db.alter_column(u'techpong_match', 'loser_rating_before', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Match.loser_rating_after'
        db.alter_column(u'techpong_match', 'loser_rating_after', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Match.winner_rating_before'
        db.alter_column(u'techpong_match', 'winner_rating_before', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Match.match_quality'
        db.delete_column(u'techpong_match', 'match_quality')


        # Changing field 'Match.winner_rating_after'
        db.alter_column(u'techpong_match', 'winner_rating_after', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'Match.loser_rating_before'
        db.alter_column(u'techpong_match', 'loser_rating_before', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'Match.loser_rating_after'
        db.alter_column(u'techpong_match', 'loser_rating_after', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'Match.winner_rating_before'
        db.alter_column(u'techpong_match', 'winner_rating_before', self.gf('django.db.models.fields.FloatField')(default=None))
